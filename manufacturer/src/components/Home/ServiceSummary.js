...
const ServiceSummary = () => {
    return (
        <div className='flex flex-row justify-center'>
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 justify-left items-center mx-2 sm:mx-20 my-10 py-3 border rounded max-w-screen-2xl'>
                <div className='flex flex-row flex-nowrap gap-3 justify-center items-center py-4 px-4 sm:border-r'>
                ...
                <div className='flex flex-row flex-nowrap gap-3 justify-left items-center py-4 px-4 lg:border-r'>
